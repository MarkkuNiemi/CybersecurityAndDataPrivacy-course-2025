...
| F-02 | 🔴 High  | Passwords stored in plaintext | All passwords are stored in plaintext in database. There should be some kind of hashing or encryption. Exposing credentials directly | See screenshot in F-01 |
